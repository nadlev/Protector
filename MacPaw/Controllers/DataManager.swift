...
class DatasetManager: ObservableObject {
    ...
    //let urlEquipmentOryx = Bundle.main.url(forResource: "russia_losses_equipment_oryx", withExtension: "json")!
        
        var personnelList = [Personnel]()
        var equipmentList = [Equipment]()
        //var equipmentOryxList = [RussiaLossesEquipmentOryx]()
    @Published var lossesDataList = [LossesData]()
    
    func fetchLossesData() {
        fetchPersonnelData()
        fetchEquipmentData()
        //fetchEquipmentOryxData()
        combineData()
    }
...
//    func fetchEquipmentOryxData() {
//            do {
//                let jsonData = try Data(contentsOf: urlEquipmentOryx)
//                let decoder = JSONDecoder()
//                let result = try decoder.decode([RussiaLossesEquipmentOryx].self, from: jsonData)
//                equipmentOryxList = result
//            } catch {
//                print(error)
//            }
//        }
